...
call s:h('DraculaRedInverse', s:yellow, s:red)
...
hi! link Class DraculaPurpleBold
hi! link Decorator DraculaOrange
hi! link Statement DraculaCyan
hi! link Exception DraculaRed
hi! link Include DraculaRed
